...
function showShop(scene, mainMenu, fromVictory = false) {
    ...
    if (currentShopTab === 'upgrades') {
        ...
        createBtn(sY, "skin_gold", "desc_gold", 200, 'skin_gold', () => { currentSkin = 'gold'; refreshPlayerAppearance(scene); }); createBtn(sY+step, "skin_ghost", "desc_ghost", 200, 'skin_ghost', () => { currentSkin = 'ghost'; refreshPlayerAppearance(scene); }); createBtn(sY+step*2, "skin_crimson", "desc_crimson", 300, 'skin_crimson', () => { currentSkin = 'crimson'; refreshPlayerAppearance(scene); }); createBtn(sY+step*3, "skin_void", "desc_void", 300, 'skin_void', () => { currentSkin = 'void_skin'; refreshPlayerAppearance(scene); }); createBtn(sY+step*4, "skin_plasma", "desc_plasma", 300, 'skin_plasma', () => { currentSkin = 'plasma'; refreshPlayerAppearance(scene); }); createBtn(sY+step*5, "skin_solar", "desc_solar", 300, 'skin_solar', () => { currentSkin = 'solar'; refreshPlayerAppearance(scene); }); createBtn(sY+step*6, "skin_frost", "desc_frost", 300, 'skin_frost', () => { currentSkin = 'frost'; refreshPlayerAppearance(scene); }); createBtn(sY+step*7, "skin_rainbow", "desc_rainbow", 0, 'skin_rainbow', () => { currentSkin = 'rainbow'; refreshPlayerAppearance(scene); }); createBtn(sY+step*8, "void_premium", "desc_void_premium", 0, 'skin_void_premium', () => { currentSkin = 'void_premium'; refreshPlayerAppearance(scene); }); createBtn(sY+step*9, "crystal", "desc_crystal", 0, 'skin_crystal', () => { currentSkin = 'crystal'; refreshPlayerAppearance(scene); }); createBtn(sY+step*10, "fx_blue_exp", "desc_blue_exp", 0, 'fx_blue', () => { currentExplosionColor = 0x00ffff; }); createBtn(sY+step*11, "fx_pink_exp", "desc_pink_exp", 0, 'fx_pink', () => { currentExplosionColor = 0xff00ff; }); createBtn(sY+step*12, "fx_rainbow_exp", "desc_rainbow_exp", 0, 'fx_rainbow', () => { currentExplosionColor = 0xffff00; }); createBtn(sY+step*13, "fx_gold_exp", "desc_gold_exp", 0, 'fx_gold', () => { currentExplosionColor = 0xffaa00; }); createBtn(sY+step*14, "fx_green_exp", "desc_green_exp", 0, 'fx_green', () => { currentExplosionColor = 0x00ff00; }); createBtn(sY+step*15, "fx_red_exp", "desc_red_exp", 0, 'fx_red', () => { currentExplosionColor = 0xff0000; }); maxScroll = step * 15;
