...
const TRANSLATIONS = {
    en: {
        ...
        helper_drone: "COMBAT DRONE", desc_helper_drone: "Auto-fires every 3s, +15% DPS",
        helper_autoshield: "AUTO-SHIELD", desc_helper_autoshield: "Blocks 1 hit per sector",
        helper_autobomb: "POST-DEATH BOMB", desc_helper_autobomb: "Explodes on death, 50% boss damage",
        helper_autoheal: "AUTO-REPAIR", desc_helper_autoheal: "Heals 5 HP every 10s",
    ...
    ru: {
        ...
        helper_drone: "БОЕВОЙ ДРОН", desc_helper_drone: "Авто-огонь каждые 3сек, +15% урона",
        helper_autoshield: "АВТО-ЩИТ", desc_helper_autoshield: "Блокирует 1 удар за сектор",
        helper_autobomb: "ПОСМЕРТНЫЙ ВЗРЫВ", desc_helper_autobomb: "Взрывается при смерти, 50% урона боссу",
        helper_autoheal: "АВТО-РЕМОНТ", desc_helper_autoheal: "Лечит 5 HP каждые 10сек",
